...
These accounts are required for Magento image installation and configuration

## Magento

Administrator account is set by yourselft at the time of Magento installation wizard
