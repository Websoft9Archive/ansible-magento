...
Here are the required username and password for Magento installation and configuration.

## Magento

* Magento administrator username: `admin`
* Magento administrator password: Get it form the file of your server */credentials/password.txt*
